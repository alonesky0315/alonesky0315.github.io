---
layout: post
title: Fastadmin基础知识（二）
category: 知识库
keywords: 
tags: 常识 JavaScript HTML 插件
description: 
---
...
解决fastadmin selectpage下拉框遮顶问题 附件：图六

找到fastadmin-selectpage/selectpage.js文件(大约1728行)，open up中添加一个判断语句
...
图六：![图六](https://blog.alonesky.com/storage/article/2021/09/27/CnIjPuxhIDucToRLNdfZUt90bVccwXXJ6zQvyw4m.png)
...
{field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, formatter: function (value, row, index) {
    ...
    if(row.pid!=1){
        ...
        $(table).data("operate-del", 'article/article/del');
    }
    that.table = table;
