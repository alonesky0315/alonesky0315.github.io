---
layout: post
title: 推荐一款完整的开发环境管理器
category: Article
keywords: Common Linux MySQL PHP Tool Article Python GO
tags: Common Linux MySQL PHP Tool Article Python GO
description: 
---
...
##### 自动版本切换
你是否已经第一百次输入 `nvm use 18` 或 `brew switch php@8.1` ？FlyEnv 通过项目级隔离完全消除了版本管理。
...
1. [下载 FlyEnv](https://flyenv.com/zh/download.html) 适用于你的平台
2. 跟随[快速入门](https://flyenv.com/zh/guide/getting-started.html)指南
3. 在 5 分钟内创建你的第一个站点